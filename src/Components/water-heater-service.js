                     ...
                     <section id="headline">
                           <div className='container'>
                             <div className='row'>
                              ...
                              <h2>Professional Water Heater Repair & Service in Tamil Nadu</h2>
                               </div>
                             </div>
                           </div>
                         </section>
                 ...
                 <section id="DESCWASH">
                   <div className='container'>
                     <div className='row'>
                       ...
                       <img src={WATERHEATERDESC} className="img-fluid" alt="washing machine service" title='washing machine service'/>
