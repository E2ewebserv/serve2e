...
import '../Components/waterheater.css';
import HEATERHERO from '../images/HEATERHERO.jpg'
import WATERHEATERDESC from '../images/WATERHEATERDESC.jpg'

// import PHONECALLPNG from '../images/PHONECALLPNG.png'
// import EMAILPNG from '../images/EMAILPNG.png'
import WATERTECH from '../images/WATERTECH.jpg'
...
useEffect(() => {
       window.scrollTo(0, 0); 
       document.title = "Water Heater Service";
     }, []);
    ...
    <div className="scroll-track">
      ...
      <div className="scroll-content" direction="left">
        ...
        🔁 30 Days Money Back If Not Satisfied * &nbsp;&nbsp;&nbsp;
                           ...
                           <section id="hero" style={{ backgroundImage: `url(${HEATERHERO})` }}>
                 ...
                 <section id="WRHY" data-aos="fade-left">
                   <div className='container'>
                     <div className='row'>
                       ...
                       <h2 data-aos="fade-left">We Are Ready To Help You</h2>
          ...
          <li> <i class='fas fa-arrow-circle-right'></i>Trusted Professional Technicians</li>
                         ...
                         <h2 data-aos="fade-right">Issues In Water Heater</h2>
                         <ul>
                           <li> <i class='fas fa-arrow-circle-right'></i>On-Off Problem</li>
                           <li> <i class='fas fa-arrow-circle-right'></i>Over Heating</li>
                           <li> <i class='fas fa-arrow-circle-right'></i>Water Leakage</li>
                           <li> <i class='fas fa-arrow-circle-right'></i>No Hot Water.</li>
                           <li> <i class='fas fa-arrow-circle-right'></i>Usage of Masks & Gloves</li>
                           <li> <i class='fas fa-arrow-circle-right'></i>The Water Takes Too Long To Reheat.</li>
                           <li> <i class='fas fa-arrow-circle-right'></i>Strange Noises</li>
                           
                         </ul>
                 
                         <h2 data-aos="fade-left">Types Of Water Heater</h2>
                         <ul>
                           <li> <i class='fas fa-arrow-circle-right'></i>Copper Pot Water Heater Service</li>
                           <li> <i class='fas fa-arrow-circle-right'></i>Fiber Pot Water Heater Service</li>
                           ...
                           <li> <i class='fas fa-arrow-circle-right'></i>Commercial Water Heater Service</li>
                 ...
                 <section id="WASHMANSIT" data-aos="fade-left">
                   <div className='container'>
                     <div className='row'>
                       <div className='col-lg-12 col-md-12 col-sm-12 col-12'>
                         <center>
                     <img src={WATERTECH} alt="washing machine service" title="washing machine service"/>
                     </center>
                     <p>We are a Fast and Reliable Water Heater Service Center. We handle all types of Electric, Gas, and Instant Water Heaters with doorstep service across Tamil Nadu. Book your complaint for same-day service. We focus on quality service and use genuine spare parts to help maintain heating efficiency and customer satisfaction.</p>
                 ...
                 <section id="STARS" data-aos="zoom-out">
                   <div className='container'>
                     <div className='row'>
                       ...
                       <div className='col-lg-4 col-md-4 col-sm-12 col-12'>
                         <center id="border">
                       <div className="star" id="STARRATE">&#9733;</div>
                       <h5>Water Heater Service Center</h5>
                       </center>
                       </div>
                       <div className='col-lg-4 col-md-4 col-sm-12 col-12'>
                         <center id="border">
...
{/*                  
                 ...
                 <p>With over 11 years of dedicated experience in the industry, Our Service Center is your trusted partner for all Water Heater service needs. Since our inception, we have committed ourselves to delivering top-notch, reliable, and efficient services, ensuring that your appliances operate at their best.</p>
                 ...
                 <section id="ours" data-aos="fade-left">
                   <div className='container'>
                     <div className='row'>
                       ...
                       <h5>Our Mission</h5>
                    <p>At our Service Center, our mission is to provide exceptional service through our expertise and commitment to customer satisfaction. We understand the importance of a properly working water heater in your daily routine and aim to reduce downtime with our prompt and professional service.</p>
                 ...
                 <section id="DESCWASH" data-aos="fade-right">
                   <div className='container'>
                     <div className='row'>
                       ...
                       <img src={WATERHEATERDESC} data-aos="fade-left" className="img-fluid" alt="washing machine service" title='washing machine service'/>
                 
                       </div>
                       <div className='col-lg-6 col-md-6 col-sm-12 col-12'>
                 
                      <h3>Water Heater Customer Support Service</h3>
                      <ul>
                     <li><strong>Technical Assistance:</strong> Troubleshoot common water heater issues: no heating, power problems, leakage, and thermostat faults.</li>
<li><strong>Installation Support:</strong> Guidance on proper installation, wall mounting, electrical or gas connections, and safe placement.</li>
<li><strong>Maintenance Advice:</strong> Tips on descaling, checking heating elements, and regular maintenance for improved efficiency and longer lifespan.</li>
                  ...
                  */}
                         ...
                         <section id="WWO" data-aos="zoom-out">
                           <div className='container'>
                             <div className='row'>
                               <div className='col-lg-12 colmd-12 col-sm-12 col-12'>
                                 <h5 data-aos="fade-left">What We Offer</h5>
