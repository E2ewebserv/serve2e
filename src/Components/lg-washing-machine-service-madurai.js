...
export default function LGWASHINGMACHINESERVICEMADURAI() {
  useEffect(() => {
    window.scrollTo(0, 0); // Scroll to the top of the page
        document.title = "LG Washing Machine Service Madurai| E2E Web Service | 9025312399";
  ...
  const aggregateRatingSchema = {
    ...
    "@type": "LocalBusiness",
    "name": "Home Appliance Service - LG Washing Machine Service Madurai",
  ...
  return (
    ...
    <Helmet>
      ...
      <link 
        rel="canonical" 
        href="https://servicee2e.in/lg-washing-machine-service-madurai" 
      />
      ...
      <meta 
        property="og:title" 
        content="Best LG Washing Machine Service Madurai 9025312399" 
      />
      <meta 
      ...
      <meta 
        property="og:url" 
        content="https://servicee2e.in/lg-washing-machine-service-madurai" 
      />
      <meta 
