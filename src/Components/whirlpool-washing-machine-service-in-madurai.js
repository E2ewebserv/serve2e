      ...
      <div className='container'>
        <div className='row'>
          <div className='col-lg-12 col-md-12 col-sm-12 col-12'>
            ...
            <h2> Whirlpool Washing Machine Customer Care Helpline Support</h2>
            <ul>
           <li> <i class='fas fa-arrow-circle-right'></i>Book Your Complaints 24*7 Customer Care</li>
            ...
            <h2>Issues In whirpool washing Machine Service</h2>
            <ul>
            ...
            <h2>Types Of whirpool washing Machine Service</h2>
            <ul>
   ...
   <li>Washing machine repair in Virattipathu</li>
      ...
      <div className='container'>
        ...
        <ul id="TAB">
          ...
          <li><a href="#DESCWASH">11. whirpool washing Machine Customer Support Service</a></li>
