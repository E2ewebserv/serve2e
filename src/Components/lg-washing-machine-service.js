              ...
              <div className='container'>
                <div className='row'>
                  <div className='col-lg-12 col-md-12 col-sm-12 col-12'>
                    <h2>NO 1 BEST LG WASHING MACHINE SERVICE</h2>
                  </div>
                </div>
              </div>
            </section>
    ...
    <section id="WASHMANSIT">
      <div className='container'>
        <div className='row'>
          <div className='col-lg-12 col-md-12 col-sm-12 col-12'>
            <center>
        <img src={WASHSIT} alt="LG washing machine service " title="lg washing machine service"/>
        </center>
    ...
    <section id="DESCWASH">
      <div className='container'>
        <div className='row'>
          ...
          <img src={WASHDESC} className="img-fluid" alt="lg washing machine service " title='lg washing machine service '/>
