...
export default function MICOWAVEOVENSERVICE() {
                        ...
                        <div className='container'>
                          <div className='row'>
                            <div className='col-lg-12 col-md-12 col-sm-12 col-12'>
                             <h2>Professional Microwave Oven Repair & Service in Tamil Nadu</h2>
                            </div>
                          </div>
                        </div>
                      </section>
      ...
      <div className="scroll-content" direction="left">
        ...
        🔁 30 Days Money Back If Not Satisfied * &nbsp;&nbsp;&nbsp;
          ...
          <li> <i class='fas fa-arrow-circle-right'></i>Trusted Professional Technicians</li>
                      ...
                      <h2>Issues In Microwave Oven</h2>
                      <ul>
              ...
              <section id="WASHMANSIT">
                <div className='container'>
                  <div className='row'>
                    <div className='col-lg-12 col-md-12 col-sm-12 col-12'>
                      <center>
                  <img src={MICROTECH} alt="washing machine service" title="washing machine service"/>
                  </center>
                  <p>We are a Fast and Reliable Microwave Oven Service Center. We handle all types of Solo, Grill, and Convection microwave ovens with doorstep service across Tamil Nadu. Book your complaint for same-day service. We focus on quality service and use genuine spare parts to help maintain heating efficiency and customer satisfaction.</p>
              ...
              <section id="ours">
                <div className='container'>
                  <div className='row'>
                    ...
                    <h5>Our Mission</h5>
                   <p>
  Our mission is to deliver excellent service through our expertise and dedication to customer satisfaction. We reduce inconvenience with prompt, professional microwave oven repairs and support.
</p>
              ...
              <section id="DESCWASH">
                <div className='container'>
                  <div className='row'>
                    ...
                    <img src={MICRODESC} className="img-fluid" alt="washing machine service" title='washing machine service'/>
                   ...
                   <ul>
                  <li><strong>Technical Assistance:</strong> Troubleshoot common microwave issues: not heating, power failure, unusual noise, and display errors.</li>
<li><strong>Installation Support:</strong> Guidance on proper microwave oven setup, placement, and safe electrical connections.</li>
<li><strong>Maintenance Advice:</strong> Tips on regular cleaning, avoiding overload, and using appropriate cookware for long-lasting performance.</li>
                      ...
                      <section id="WWO">
                        <div className='container'>
                          <div className='row'>
                            <div className='col-lg-12 colmd-12 col-sm-12 col-12'>
                              <h5>What We Offer</h5>
                            <p><strong>Expert Technicians:</strong> Our team includes experienced and skilled technicians with in-depth knowledge of all types of microwave ovens, including Solo, Grill, and Convection models.</p>
<p><strong>Comprehensive Services:</strong> From routine maintenance to advanced microwave oven repairs, we handle every aspect of servicing with care and precision.</p>
<p><strong>Customer-Centric Approach:</strong> We focus on your needs and provide personalized service solutions to ensure a smooth and convenient experience.</p>
<p><strong>Quality Assurance:</strong> We use genuine spare parts and follow high service standards to help maintain your microwave oven’s performance and safety.</p>
<p><strong>Affordable Pricing:</strong> Our microwave oven services are reasonably priced, offering dependable support without exceeding your budget.</p>
                            </div>
                          </div>
                        </div>
                      </section>
