...
import './Navbar.css';
import logo from  '../images/CANVA.jpg';
      ...
      <ul className='navbar-nav nav-center w-100 mb-2 mb-lg-0'>
        ...
        <li className='nav-item dropdown'>
          ...
          <ul className='dropdown-menu' aria-labelledby='navbarDropdown'>
            ...
            <li><Link className='dropdown-item' to='/microwave-oven-service'>Microwave Oven Service</Link></li>
            <li><Link className='dropdown-item' to='/water-heater-service'>Water Heater Service</Link></li>
            <li><Link className='dropdown-item' to='/water-purifier-service'>Water Purifier Service</Link></li>
          </ul>
        </li>
      </ul>
    </div>
